// frontend/src/admin/pages/BookInventory.jsx
        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Book Inventory Management</h1>
                </div>
                <p className="text-gray-600">Add and manage school books and stock by class</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-yellow-500">
                    ...
                    <p className="text-3xl font-bold text-yellow-600">{totalIssued}</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-red-500">
                    ...
                    <p className="text-3xl font-bold text-red-600">{totalDamaged}</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
                <div className="flex items-center gap-2 overflow-x-auto">
                    <span className="text-sm font-medium text-gray-700 mr-2">Select Class:</span>
                        ...
                        {classes.map(cls => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium transition whitespace-nowrap ${selectedClass === cls
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6 mb-6 border border-blue-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <p className="text-2xl font-bold text-gray-900">{currentClassBooks.length}</p>
                    </div>
                    <div>
            ...
            {!showForm && (
                <div className="mb-6">
                    ...
                    >
                        ...
                        Add Book to Class {selectedClass}
                    </button>
                </div>
            )}
                            ...
                            <div key={book._id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold text-gray-900">{book.totalStock}</p>
                                        </div>
                                        <div>
                                            <p className="text-gray-600 text-xs font-medium">Issued</p>
                                            <p className="text-2xl font-bold text-blue-600">{book.issuedCount || 0}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold text-red-600">{book.damagedCount || 0}</p>
                                        </div>
                                    </div>
                                ...
                                {isExpanded && (
                                    <div className="border-t border-gray-200 bg-gray-50 p-6">
                                        <h4 className="font-bold text-gray-900 mb-4">Book Details</h4>
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                            {book.isbn && (
                                                <div className="bg-white p-3 rounded-lg border border-gray-200">
                                                    <p className="text-gray-600 text-xs font-medium">ISBN</p>
                                                    <p className="text-sm font-semibold text-gray-900 mt-1">{book.isbn}</p>
                                                </div>
                                            )}
                                            {book.publisher && (
                                                <div className="bg-white p-3 rounded-lg border border-gray-200">
                                                    <p className="text-gray-600 text-xs font-medium">Publisher</p>
                                                    <p className="text-sm font-semibold text-gray-900 mt-1">{book.publisher}</p>
                                                </div>
                                            )}
                                            {book.edition && (
                                                <div className="bg-white p-3 rounded-lg border border-gray-200">
                                                    <p className="text-gray-600 text-xs font-medium">Edition</p>
                                                    <p className="text-sm font-semibold text-gray-900 mt-1">{book.edition}</p>
                                                </div>
                                            )}
                                            {book.price > 0 && (
                                                <div className="bg-white p-3 rounded-lg border border-gray-200">
                                                    <p className="text-gray-600 text-xs font-medium">Price</p>
                                                    <p className="text-sm font-semibold text-gray-900 mt-1">₹{book.price.toFixed(2)}</p>
                                                </div>
                                            )}
                                            {book.createdAt && (
                                                <div className="bg-white p-3 rounded-lg border border-gray-200">
